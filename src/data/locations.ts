...
export const SHELVES: Shelf[] = [
  ...
  { id: "sh1", section_id: "s1", shelf_index: 1 },
  { id: "sh2", section_id: "s1", shelf_index: 2 },
  { id: "sh3", section_id: "s1", shelf_index: 3 },
  // s2 - Narrativa straniera (3 scaffali)
  { id: "sh4", section_id: "s2", shelf_index: 1 },
  { id: "sh5", section_id: "s2", shelf_index: 2 },
  { id: "sh6", section_id: "s2", shelf_index: 3 },
  // s3 - Saggistica (2 scaffali)
  { id: "sh7", section_id: "s3", shelf_index: 1 },
  { id: "sh8", section_id: "s3", shelf_index: 2 },
  // s4 - Fantasy (3 scaffali)
  { id: "sh9", section_id: "s4", shelf_index: 1 },
  { id: "sh10", section_id: "s4", shelf_index: 2 },
  { id: "sh11", section_id: "s4", shelf_index: 3 },
  // s5 - Tecnica (2 scaffali)
  { id: "sh12", section_id: "s5", shelf_index: 1 },
  { id: "sh13", section_id: "s5", shelf_index: 2 },
  // s6 - Storia e Filosofia (2 scaffali)
  { id: "sh14", section_id: "s6", shelf_index: 1 },
  { id: "sh15", section_id: "s6", shelf_index: 2 },
  // s7 - Letture correnti (2 scaffali)
  { id: "sh16", section_id: "s7", shelf_index: 1 },
  { id: "sh17", section_id: "s7", shelf_index: 2 },
];
